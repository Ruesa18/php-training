 ...
 * Inside of this new ExerciseClass please override the value 'lol' of the message attribute with something different.
 *
 ...
 */
// TODO: Define a class named `ExerciseClass` and extend the `\name\base\ExerciseBaseClass`.
// TODO: After that override the attribute named `message` with something other than the string 'lol'
